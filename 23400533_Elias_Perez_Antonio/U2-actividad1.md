...
db.usuarios.find({carrera:"Ingeneria Informatica",semestre:{$gte:6}})
...
db.usuarios.find(
  { carrera: { $in: ["Ingeniería en Sistemas Computacionales","Ingeniería Informática"] } },{ nombre: 1, carrera: 1, _id: 0 })
